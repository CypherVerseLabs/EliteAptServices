...
E
      ...
      <div className="border-t border-slate-800 p-4">
        <Link
          ...
          className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm text-slate-400 hover:bg-slate-800 hover:text-white"
        >
        ...
        <Link
          href="/login"
          className="mt-1 flex items-center gap-3 rounded-xl px-4 py-3 text-sm text-slate-400 hover:bg-slate-800 hover:text-white"
        >
